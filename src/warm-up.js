...
// 'We need to get some more [food].'
  var stockCount = inStock; //Variable wasn't yet declared -- assuming it needs to be?
  if (stockCount >= 1) {
    console.log(`I'm going to eat some ${food}!`)
  } else {
    console.log(`We need some more ${food}.`);
  }
...
// vegetables, represented by their names as Strings.
  var vegetables = ["carrots", "beets", "parsnips", "corn", "cucumbers"];
...
// different fruits.
  var fruits = ["strawberries", "blueberries", "watermelons", "applies",
  "raspberries", "oranges", "limes"]
...
// notation to do this. DO NOT modify your code from above.
  groceryStore.location = "Denver, Coloardo";
